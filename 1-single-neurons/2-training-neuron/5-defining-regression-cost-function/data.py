...
ad_spends = inputs
predictions = [ad_spend*.4 + 100 for ad_spend in ad_spends]
predictions

coupled_predictions = list(zip(outcomes, predictions))
errors = [outcome - prediction for outcome, prediction in coupled_predictions]
errors
